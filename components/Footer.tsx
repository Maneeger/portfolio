  ...
  return (
    <footer className="pt-10 bg-midnight">
      <div className="max-w-screen-xl mx-auto px-4 md:px-8">
        ...
        <div className="mt-10 py-10 border-t border-gray-700 items-center justify-between sm:flex">
          ...
          <div className="flex items-center gap-x-6 text-gray-400 mt-6">
            <a href="https://www.facebook.com/samuelebubechukey"  rel="noopener noreferrer">
              <svg
            ...
            <a href="https://twitter.com/@samuel369166">
              <svg
                className="w-6 h-6 hover:text-gray-500 duration-150"
                fill="none"
                viewBox="0 0 48 48"
            ...
            <a href="https://github.com/maneeger">
              <svg
                className="w-6 h-6 hover:text-gray-500 duration-150"
                fill="none"
                viewBox="0 0 48 48"
